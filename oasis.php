		...
		<div id="bigPic" class="clsBigPic">
			<div class="wrap">
				...
				<div class="portfolio_pg_lft">
          		...
          		<li class="activeHeader_pg"><a href="oasis.php">Oasis</a></li>
            ...
            <img class="pg2_img" src="images/Oasis-1.jpg" alt="Oasis" title="Oasis" />
            <img class="pg2_img" src="images/Oasis-2.jpg" alt="Oasis" title="Oasis" />
            <img class="pg2_img" src="images/Oasis-3.jpg" alt="Oasis" title="Oasis" />
            <img class="pg2_img" src="images/Oasis-4.jpg" alt="Oasis" title="Oasis" />
            <img class="pg2_img" src="images/Oasis-5.jpg" alt="Oasis" title="Oasis" />
 					</div>
        </div>							
			</div>
		</div>
