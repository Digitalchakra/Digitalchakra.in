...
<div id="bodyContent" class="clsBodyContent">
		...
		<div id="bigPic" class="clsBigPic">
            ...
            <img class="pg2_img" src="images/anabond1.png" alt="Anabond" title="Anabond" />
            <img class="pg2_img" src="images/anabond2.png" alt="Anabond" title="Anabond" />
            <img class="pg2_img" src="images/anabond3.png" alt="Anabond" title="Anabond" />
            <img class="pg2_img" src="images/anabond4.png" alt="Anabond" title="Anabond" />
 					</div>
        </div>							
			</div>
		</div>
