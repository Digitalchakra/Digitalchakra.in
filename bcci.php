		...
		<div id="bigPic" class="clsBigPic">
			<div class="wrap">
				...
				<div class="portfolio_pg_lft">
          		...
          		<li class="activeHeader_pg"><a href="bcci.php">BCCI</a></li>
            ...
            <h1>BCCI Website</h1>
            <a href="http://www.bcci.com" target="_blank">Goto Website</a>
            <div class="clearall"></div>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec vitae elit et nibh sagittis rutrum non quis lorem.</p>
            <img class="pg2_img" src="images/BCCI-home.png" alt="BCCI" title="BCCI" />
            <img class="pg2_img" src="images/BCCI -Live-Scores-Latest-Cricket-ipl.png" alt="BCCI" title="BCCI" />
            <img class="pg2_img" src="images/BCCI-rank.png" alt="BCCI" title="BCCI" />
 					</div>
        </div>							
			</div>
		</div>
