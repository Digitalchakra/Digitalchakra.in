		...
		<div id="bigPic" class="clsBigPic">
			<div class="wrap">
				...
				<div class="portfolio_pg_lft">
					<ul class="">
          		<li class="activeHeader_pg"><a href="ezcv.php">EZCV</a></li>
            ...
            <h1>EZCV Website</h1>
            <a href="http://ezcv.in/" target="_blank">Goto Website</a>
            <div class="clearall"></div>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec vitae elit et nibh sagittis rutrum non quis lorem.</p>
            <img class="pg2_img" src="images/EZCV1.png" alt="Oasis" title="Oasis" />
            <img class="pg2_img" src="images/EZCV2.png" alt="Oasis" title="Oasis" />
 					</div>
        </div>							
			</div>
		</div>
