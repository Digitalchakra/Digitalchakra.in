		...
		<div id="bigPic" class="clsBigPic">
			<div class="wrap">
				...
				<div class="portfolio_pg_lft">
          		...
          		<li class="activeHeader_pg"><a href="mobile-apps.php">Mobile Apps</a></li>
            ...
            <img class="pg2_img" src="images/mobile-app1.jpg" alt="Mobile-Application" title="Mobile Application" />
            <img class="pg2_img" src="images/mobile-app2.jpg" alt="Mobile-Application" title="Mobile Application" />
            <img class="pg2_img" src="images/mobile-app3.jpg" alt="Mobile-Application" title="Mobile Application" />
 					</div>
        </div>							
			</div>
		</div>
