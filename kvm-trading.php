		...
		<div id="bigPic" class="clsBigPic">
			<div class="wrap">
				...
				<div class="portfolio_pg_lft">
          		...
          		<li class="activeHeader_pg"><a href="kvm-trading.php">KVM Trading</a></li>
            ...
            <h1>KVM Trading Website</h1>
            <a href="http://www.kvmtrading.com/" target="_blank">Goto Website</a>
            <div class="clearall"></div>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec vitae elit et nibh sagittis rutrum non quis lorem.</p>
            <img class="pg2_img" src="images/KVM-Trading-home.png" alt="KVM Trading" title="KVM Trading" />
            <img class="pg2_img" src="images/KVM-Trading-what-we-do.png" alt="KVM Trading" title="KVM Trading" />
 					</div>
        </div>							
			</div>
		</div>
