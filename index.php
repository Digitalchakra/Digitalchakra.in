					...
					<div>
						<div class="touchslider-item">
							<div id="carousel1">
								...
								<p class="contentText">We form a seamless extension of your team so that you are freed up to concentrate on the core activities of your business. We help you take your bright idea to success backed by strong development processes and best practices. Our services include:</p>
						...
						<div class="touchslider-item">
							<div id="carousel6">
								...
								<br/><br/>
								<p class="contentText">Taking you to the cloud. Whether you are looking to improve/leverage your existing cloud investment or trying to get there we can do it for you. We have a dedicated group of system admins who can deploy, support and maintain your application on the cloud.</p>
								<ul style=" margin:16px;" class="contentText">
